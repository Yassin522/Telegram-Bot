...
Hamza_JOKES = [
    "حمزة ما بيمشي مع الناس لما يطلعوا يحرروا سوريا؛ هو اللي بيقعد بالبيت وبيقول 'بخاف يطلعلي بشار من أي زاوية!'",
    "ليش حمزة ما نزل يحتفل بعد ما تحررت سوريا؟ لأنه قاعد عم ينتظر تأكيد رسمي من كل القنوات العالمية!",
    "حمزة أول ما عرف أنه سوريا تحررت، ضل قاعد بالبيت أسبوع كامل عم يتأكد إنه مو حلم.",
    "لما قالوا لحمزة 'يلا نزل على الشارع نحتفل'، رد عليهم: 'ليش؟ الشارع ما حيحتفل لحالو؟!'",
    "حمزة ما بيحتاج يشارك بالمظاهرات؛ المظاهرات أصلاً بتستمد قوتها من خوفه!",
    "ليش حمزة ما فتح الباب أسبوع بعد التحرير؟ لأنه خايف إذا فتح يطلعله 'شبيح' صار مندس!",
    "حمزة بيقول: 'إذا ضليت بالبيت، ما حدا حيقدر يقول عني لا ثائر ولا مندس... أنا بس بحب السلامة!'",
    "حتى بعد ما سوريا تحررت، حمزة قاعد عم يتفرج على الأخبار بخوف وبيقول: 'خلينا نستنى شوي، يمكن في جزء تاني من الفيلم!'",
    "لما طلبوا من حمزة يحكي عن يوم التحرير، قال: 'أكتر يوم ممل... قعدت بالبيت، بس كنت حاسس الجو فيه ريحة حرية!'",
    "حمزة ما بيسأل 'مين حرر سوريا؟' هو بس بيسأل: 'طيب متأكدين إنه بشار مو مستخبي بشي قبو؟'",
    "حمزة لما أخدوا صورة لعلم سوريا الجديد، كان أول واحد يقعد قدامه ويقول: 'منيح، بس خلينا نراقب الوضع شوي!'",
    "ليش حمزة ما بينام برا البيت؟ لأنه خايف إذا غفا يجي حدا يقله: 'قوم بشار رجع!'",
    "حمزة بيفكر يعمل مذكراته عن أسبوع التحرير، بس كل صفحة مكتوب عليها: 'قعدت... وشربت شاي!'",
    "كل العالم عم تقول: 'الحرية أحلى شعور!' بس حمزة بيقول: 'الأمان بالبيت أحلى من الحرية!'",
    "لما الجيران صاروا يحتفلوا تحت البيت، حمزة حط السماعات على ودانه وقال: 'أنا حر من الإزعاج!'",
]


Mardini_JOKES = [
    "مارديني لما عرف إنه سوريا تحررت، أول كلمة قالها لجيرانه: 'عاملين إيه يا جدعان؟ الدنيا أمان عندكم؟!'",
    "ليش مارديني ما نزل يحتفل؟ لأنه كان بالبيت عم يتعلم يقول 'إزيك يا باشا!' تحسباً للسفر على مصر.",
    "أول ما سمع مارديني خبر التحرير، صار يحكي مع رفقاته: 'يا يسطا، إنت شايف الوضع آمن ولا نخلع؟!'",
    "مارديني صار يحضر أفلام مصرية بكثافة بعد التحرير، بس ليحس إنه جاهز يعيش هناك إذا اضطر.",
    "لما قالوا لمارديني 'نزل واحتفل'، رد عليهم: 'ليه يا عم؟ نخليها على الهادي كده أحسن!'",
    "مارديني قاعد بالبيت وبيحكي مع حاله بالمصري: 'الدنيا مش مضمونة يا رايق، خلينا نبقى نجهز نفسنا!'",
    "أسبوع كامل ومارديني ما فتح الباب، بس صوته من ورا الباب كان يقول للجيران: 'مش وقته يا عم، نأمن نفسنا الأول!'",
    "حتى لما صار التحرير، مارديني صار ينده على أخوه: 'يا يسطا، هاتلي الخريطة كده أشوف القاهرة فين بالضبط!'",
    "ليش مارديني صار يشتري كتب بالمصري؟ لأنه مقتنع إنه لو طلع على مصر، لازم يبقى عنده اللكنة الصحيحة.",
    "لما صار التحرير، الجيران نزلوا يحتفلوا، ومارديني قاعد عالشباك يقول: 'الناس دي مجانين ولا إيه؟!'",
    "مارديني لما شاف أول خبر عن التحرير، قال: 'يا باشا، الوضع مش مضمون... نروح على مصر نأمن نفسنا شوية!'",
    "ليش مارديني صار يتدرب يقول 'يا جدعان'؟ لأنه خايف يوصله خبر ويلاقي حاله بالمطار عالطريق للقاهرة فجأة.",
    "حتى لما حدا ناداه باسم 'مارديني'، صار يرد عليهم: 'قول يا يسطا، أنا معاك!'",
    "لما طلبوا من مارديني يحكي عن التحرير، قال: 'والنبي ما أعرف، كنت مجهز الشنطة وأقول يا كريم نسافر!'",
    "مارديني صار يخلص حديثه مع كل حدا بجملة: 'ماشي يا باشا، إن شاء الله الدنيا تعدي على خير!'",
]



MAHMOUD_JOKES = [
    "محمود إذا حدا قال له: 'ليش ما عم نشوفك؟' بيرد: 'الشغل يا زلمة، النوم رفاهية أنا ما بعرفها!'",
    "ليش محمود ما عنده يوم عطلة؟ لأنه مقتنع إنه 'العطلة للضعاف، والشغل عبادة!'",
    "مرة سألنا محمود: 'إيمتى آخر مرة شفت الشمس؟' قالي: 'شو هي الشمس؟ اسم مسلسل شي؟!'",
    "محمود إذا قالوله: 'ليش ما بتروح ترتاح؟' بيجاوب: 'لشو الراحة؟ الشغل أحلى وما بخون!'",
    "كل مرة بدنا نحكي مع محمود، منلاقيه حامل كاسة قهوة وعم يحكي مع حاله: 'خلص، هاد آخر شفت!'... وبيطلع عنده كمان شفت بعده!",
    "ليش محمود صار يقول عن الكرسي بالمكتب 'حبيبي'؟ لأنه بيقعد عليه أكتر ما بيقعد مع أهله!",
    "مرة طلبوا من محمود يكتب وصيته، كتب: 'أنا بوصي الشفت اللي بعدي يكمل شغلي عالتمام!'",
    "محمود إذا طلبوا منه يطفّي الكمبيوتر، بيحس إنه خيانة للقسم اللي أخده بالشغل!",
    "ليش محمود ما بيطلب استراحة؟ لأنه بيعتبر إنو المكيف بالمكتب هو 'الهوا الطلق' تبعو!",
    "لما قلنا لمحمود: 'ليش ما بتروح تتغدى؟'، قالي: 'الأكل مضيعة وقت، الشغل أهم!'",
    "حتى لما بدنا نفاجئ محمود بحفلة عيد ميلاده، ما قدرنا نمسكه، كان بقاعة الاجتماعات عم يحضر تقرير!",
    "مرة قلنا لمحمود: 'إيمتى بتروح عالبيت؟'، قالي: 'وين البيت؟ أنا صار مكتبي بيتي!'",
    "محمود صار يحلم بالشغل، بيقلي: 'حتى بغيابي الشغل بدو مين يراقب عليه!'",
    "إذا طلبت من محمود يعمل شي إليك، بيقلك: 'بعد الدوام'... وبيخلص دوامو بس بعد 10 سنين!",
    "محمود صار يمشي ومعه لابتوب بالحديقة، قلنا له: 'ليش؟'، قالي: 'لشو وقت الفراغ إذا فيني أنجز؟!'",
]
...
async def hamza_joke(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(random.choice(Hamza_JOKES))

async def mardini_joke(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(random.choice(Mardini_JOKES))
async def mahmoud_joke(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(random.choice(MAHMOUD_JOKES))
...
if __name__ == '__main__':
    ...
    application.add_handler(CommandHandler('hamza', hamza_joke))
    application.add_handler(CommandHandler('mardini', mardini_joke))
    application.add_handler(CommandHandler('mahmoud', mahmoud_joke))
