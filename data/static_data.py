"""
Static data for the Telegram Bot
"""
...
JOKES = [
    ...
    "Mardini's secret to success? He doesn't study the night before exams; he negotiates with the exam paper!",
    ...
    "The real mystery isn't Mardini's grades—it's how he manages to pass without a single library visit!",
    "Mardini doesn't need study groups. He's a one-man university success story!",
    ...
    "Mardini's motto: Why memorize formulas when you can charm the professor instead?"
]
...
KEYWORD_RESPONSES = {
    ...
    "مارديني": "الكوري الخايف من حط المعجونة المصري المكسيكي الفاقس المشنص ",
    "يحيى": "هب من الحد",
    ...
    "حمدي": " كوع من السود وصار مع حكومة الامر الواقع",
    ...
    "قيد": "كلو من ورا اغيد",
    "فاقس": "عاش",
    "سمير":"قصو مع جماعة حكومة الامر الواقع",
}
...
# Hangman words
HANGMAN_WORDS = ["PYTHON", "TELEGRAM", "BOT", "GAME", "PROGRAMMING", "COMPUTER", "NETWORK"]
